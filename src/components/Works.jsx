    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          At Nova, we proudly serve a diverse range of industries by delivering tailored digital solutions that meet the unique needs of each sector. While our experience spans across eCommerce, technology, field services, education, real estate, healthcare, and professional services, we specialize in helping digital agencies succeed by providing top-notch white-label development support. Whether it's building an online store, developing a custom CRM, designing a corporate website, or creating a lead-generating landing page, we adapt our approach to align with your business goals. Our team understands the nuances of each industry and is committed to delivering results that drive growth and enhance digital presence.
        </p>
      </div>
